...
//      autoUpdateInput: false,
   ...
   $("#doAddPusat").click(function (e) {
      e.preventDefault();
      document.getElementById("myFormUser").reset();
      $("#myModalLabel").text("Add New Pusat User Form");
      $("#btnAddNew").show();
      $("#btnUpdate").hide();

      $('input[name=typeadd]').val('pusat');
   ...
   $("#doAddWil").click(function (e) {
      e.preventDefault();
      document.getElementById("myFormUser").reset();

      $("#myModalLabel").text("Add New Wilayah User Form");
      $("#btnAddNew").show();
      $("#btnUpdate").hide();

      $('input[name=typeadd]').val('wilayah');
...
function doUnitOptions(t) {

   if ($(t).val() == 40)
   {
      $("#unitOptions").show(500);
   } else
   {
      $("#unitOptions").hide(500);
