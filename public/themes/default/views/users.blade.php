         ...
         <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                  ...
                  <div class="x_content">
                     <button type="button" id="doAddPusat" class="btn btn-sm btn-success">
                        <span class="docs-tooltip" data-toggle="tooltip" title="">
                           <span class="fa fa-plus-circle"></span> Add Pusat
                        </span>
                     </button>

                     <button type="button" id="doAddWil" class="btn btn-sm btn-success">
                        <span class="docs-tooltip" data-toggle="tooltip" title="">
                           <span class="fa fa-plus-circle"></span> Add Wilayah
                        </span>
                     </button>


                     <button type="button" id="doAddUnit" class="btn btn-sm btn-success">
                        <span class="docs-tooltip" data-toggle="tooltip" title="">
                           <span class="fa fa-plus-circle"></span> Add Unit
                        </span>
                     </button>

                     <button type="button" id="doEdit" class="btn btn-sm btn-success">
                        <span class="docs-tooltip" data-toggle="tooltip" title="">
                           <span class="fa fa-pencil"></span> Edit
                        </span>
                     </button>
                     <button type="button" id="doDel" class="btn btn-sm btn-success">
                        <span class="docs-tooltip" data-toggle="tooltip" title="">
                        ...
                        <table id="tblrowclick" class="table table-striped jambo_table bulk_action">
                           <thead>
                              <tr class="headings">
                                 ...
                                 <th class="column-title">Devision Code </th>
                           ...
                           <tbody>
                              ...
                              <tr class="even pointer">
                                 ...
                                 <td class=" ">{{ @$row['division_code'] }}</td>
                                 <td class=" ">{{ @$row['unit_code'] }}</td>
                              </tr>
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-5">
                           <div class="pull-left">
                              ...
                              <input type="hidden" id="jumptopageinput" value="{{ route('user-page') }}" />
                        ...
                        <div class="col-sm-7">
                           ...
                           <!--                           <div class="btn-group  pull-right">
                                                         <a class="btn btn-default btn-sm {!! $paging['pageNo'] == 1 ? 'disabled' : '' !!}" id="btn_prevpage" href="{!! $paging['pageNo'] == 1 ? '#' : route('user-page', [  'page'=>($paging['pageNo']-1), 'sort'=>'', 'rp'=>'', 'search'=>$persist ]) !!}"><span class="fa fa-arrow-left">&nbsp;</span></a>
                                                         <input id="pageinput" class="fl btn pageinput" type="text" value="{{ $paging['pageNo'] }}" />
                                                         <a class="btn btn-default btn-sm {!! $paging['pageNo'] == $paging['totalPage'] ? 'disabled' : '' !!}" id="btn_nextpage" href="{!! $paging['pageNo'] == $paging['totalPage'] ? '#' : route('user-page', [  'page'=>($paging['pageNo']+1), 'sort'=>'', 'rp'=>'', 'search'=>$persist ]) !!}"><span class="fa fa-arrow-right">&nbsp;</span></a>
                                                      </div>-->
                           @endif

                           @if(count($list))
                           <div class="btn-group  pull-right">
                              <button type="button" class="btn btn-default btn-sm {!! $paging['pageNo'] == 1 ? 'disabled' : '' !!}" @if($paging['pageNo'] == 1) '' @else onclick="location.href = '{!!  route('user-page', [  'page'=> ($paging['pageNo']-1), 'sort'=>'', 'rp'=>'', 'search'=>$persist ]) !!}'" @endif>
                                      <span class="docs-tooltip" data-toggle="tooltip" title="">
                                    <span class="fa fa-arrow-left"></span> pre
                                 </span>
                              </button>
                              <input id="pageinput" class="fl btn pageinput" type="text" value="{{ $paging['pageNo'] }}" />
                              <button type="button" class="btn btn-default btn-sm {!! $paging['pageNo'] == $paging['totalPage'] ? 'disabled' : '' !!}" @if($paging['pageNo'] == $paging['totalPage']) '' @else onclick="location.href = '{!!  route('user-page', [ 'page'=> ($paging['pageNo']+1), 'sort'=>'', 'rp'=>'', 'search'=>$persist ]) !!}'" @endif>
                                      <span class="docs-tooltip" data-toggle="tooltip" title="">
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form id="myFormUser" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            ...
            <input type="hidden" name="typeadd" >
            ...
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" id="myInputFirst" name="username" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
               </div>
               <div class="form-group">
...
<!--               <div class="form-group">
                  <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Division <span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <select class="select2_single  form-control" name="division_code" tabindex="-1">
                        <option></option>
